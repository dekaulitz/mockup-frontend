...
import {faCalendar, faEdit, faSignOutAlt, faUser, faUsers,faWindowClose} from '@fortawesome/free-solid-svg-icons'
import {FontAwesomeIcon} from '@fortawesome/vue-fontawesome'
import JSONEditor from 'jsoneditor/dist/jsoneditor.min'
import 'jsoneditor/dist/jsoneditor.min.css'

const moment = require('moment');
library.add(faUser, faUsers, faEdit, faSignOutAlt, faCalendar,faWindowClose);
